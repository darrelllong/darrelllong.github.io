...
excerpt: "Ceph’s origins in the SSRC, the earlier work on Swift and RAMA, and Dr. Sage Weil’s research and development of the file system."
---

Ceph came out of the [Storage Systems Research Center (SSRC)](https://www.ssrc.us/proj/exscale.html) at UC Santa Cruz, which Dr. Ethan Miller and I built together. I coauthored the [2006 Ceph paper](/publications/59/) with Dr. Sage Weil, Dr. Scott Brandt, Dr. Ethan Miller, and Dr. Carlos Maltzahn.
...
The separation of metadata from data, with separate servers handling each, came from my work with Dr. Luis-Felipe Cabrera on Swift, beginning in 1989. A client obtained the information it needed from the metadata service and then transferred data directly to and from the storage servers. The metadata server did not have to carry the data traffic.
